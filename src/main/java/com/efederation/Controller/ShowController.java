...
public class ShowController {
    ...
    public ResponseEntity<ApiResponse<List<ShowResponse>>> getShowsByCharacterId(@PathVariable String id) {
        ApiResponse<List<ShowResponse>> showsResponse = showService.getShowsByCharacterId(id);
